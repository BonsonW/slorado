...
${MINIMAP2} -cx map-ont ${REFERENC_GENOME} -t8 --secondary=no ${FASTQ_FILE} | awk '{print $10/$11}' | datamash mean 1 sstdev 1 q1 1 median 1 q3 1 n 1 || die "Error in identity calculation"
