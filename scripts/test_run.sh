...
/usr/bin/time  --verbose ./slorado basecaller -c 10000 -C $BATCHSIZE -B500M -x $DEVICE --verbose 5 /install/dorado-0.3.4/models/dna_r10.4.1_e8.2_400bps_${MODEL}@v4.2.0 $BLOW5 > reads.fastq
