...
public:
    ...
    virtual std::vector<DecodedChunk> call_chunks(int num_chunks,timestamps *ts) = 0;
...
public:
    ...
    std::vector<DecodedChunk> call_chunks(int num_chunks,timestamps* ts) final; //to prevent overriding of virtual function
