# Building CPU-only version of slorado on x86_64

1. For slorado CPU version, a minimum g++ version of 5.4 (available by default in Ubuntu 16) is required due to libtorch v2.0.0 we use currently. You can check your g++ version as `g++ --version`.
