...
|---              | ---             | ---         |
| 0.4.0-beta,0.5.0-beta,0.6.0           | 2.28           | SUSE Linux 15 - Instinct MI250X; Rocky Linux 9.6 - Instinct MI300X; Ubuntu 22 - Radeon 7900XTX        |
||||
